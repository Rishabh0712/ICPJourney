...
import { idlFactory } from './threshold_ecdsa_backend.did.js';
export { idlFactory } from './threshold_ecdsa_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.THRESHOLD_ECDSA_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./threshold_ecdsa_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the threshold_ecdsa_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./threshold_ecdsa_backend.did.js")._SERVICE>}
 */
export const threshold_ecdsa_backend = createActor(canisterId);
